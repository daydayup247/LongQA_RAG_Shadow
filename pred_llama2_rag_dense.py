...
def parse_args(args=None):
    ...
    parser.add_argument('--model', type=str, default=None, choices=["llama2-7b-chat-4k-rag"])
...
def get_pred(data, max_length, max_gen, prompt_format, dataset, model_name, out_path):
    K = 4
    encoder = '/home/longtext/tct_colbert-v2-hnp-msmarco'  # The file name where your encoder model is stored
...
if __name__ == '__main__':
    ...
    for dataset in datasets:
        data = load_dataset('json', data_files=f'/home/longtext/data/longbench_data/{dataset}.jsonl', split='train')  # The file name where your dataset is stored
