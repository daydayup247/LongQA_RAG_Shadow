...
def get_pred(data, data_shadow, data_rag, max_length, max_gen, prompt_format, dataset, model_name, out_path):
    ...
    model_id = "/home/llama/llama-2-7b-chat-hf"
...
if __name__ == '__main__':
    ...
    for dataset in datasets:
        ...
        answer_data_shadow = load_dataset('json', data_files=f'/home/longtext/LongBench/pred/llama2-7b-chat-4k-shadow/{dataset}.jsonl', split='train')
        answer_data_rag = load_dataset('json', data_files=f'/home/jcyao/longtext/LongBench/pred/llama2-7b-chat-4k-rag/{dataset}.jsonl', split='train')
        if not os.path.exists(f"pred/{model_name}-discriminator-18.2"):
